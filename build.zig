...
pub fn build(b: *std.Build) void {
    ...
    const bench_step = b.step("bench", "Run eval benchmark");
    bench_step.dependOn(&bench_run.step);

    const bench_asm = b.addObject(.{
        .name = "eval-bench-asm",
        .root_module = b.createModule(.{
    ...
    _ = bench_asm.getEmittedAsm();

    const install_bench_asm = b.addInstallFile(bench_asm.getEmittedAsm(), "eval-bench.s");
